				...
				<form method="post" action="islem.php">
					<table cellspacing="0" class="shop_table cart">
						...
						<tbody>
							...
							$bul = mysqli_query($baglanti,"select * from teklifler where teklif_veren_kisi='$kadi'");
					...
					<div class="col-md-3">
					<button id="yenile" type="submit" name="yenile" class="add_to_cart_button">Yenile</button>
					</div>
				</form>
