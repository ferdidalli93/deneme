        ...
        <div class="row">
            <div class="col-md-4">
                <div class="single-sidebar">
                    <h2 class="sidebar-title">Ürün Arama</h2>
                    <form action="">
                                        ...
                                        if (mysqli_affected_rows($baglanti)) 
                                        {
                                            ...
                                            while($row = mysqli_fetch_assoc($bul))
                                            {
                                                ...
                                                <tr class="cart_item">
                                                    ...
                                                    <?php echo $urunum['urun_adi'];?><strong class="product-quantity"> X <?php echo $row['sepet_adet']; ?></strong> </td>
                                                        <td class="product-total">
                                                            <span class="amount"><?php echo $toplam = $row['sepet_adet'] * $urunum['urun_fiyat'];?>₺</span> </td>
                                                        </tr>
